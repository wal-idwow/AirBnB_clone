...
class TestCityInstantiation(unittest.TestCase):
    ...
    def test_06_state_id_is_public_class_attribute(self):
        city_instance = City()
    ...
    def test_13_instantiation_with_kwargs(self):
        current_datetime = datetime.today()
    ...
    def test_14_instantiation_with_None_kwargs(self):
