...
class TestBaseModelInstantiation(unittest.TestCase):
    ...
    def test_06_two_base_models_unique_ids(self):
        bm1 = BaseModel()
        bm2 = BaseModel()
        self.assertNotEqual(bm1.id, bm2.id)

    def test_07_two_base_models_different_created_at(self):
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
        self.assertLess(bm1.created_at, bm2.created_at)

    def test_08_two_base_models_different_updated_at(self):
        bm1 = BaseModel()
        sleep(0.05)
        bm2 = BaseModel()
...
class TestBaseModelToDict(unittest.TestCase):
    ...
    def test_03_to_dict_contains_added_attributes(self):
        bm = BaseModel()
        bm.middle_name = "walid"
        bm.my_number = 98
        self.assertEqual("walid", bm.middle_name)
    ...
    def test_05_to_dict_output(self):
        ...
        bm = BaseModel()
        bm.id = "123456"
        bm.created_at = bm.updated_at = current_datetime
        tdict = {
            'id': '123456',
            '__class__': 'BaseModel',
